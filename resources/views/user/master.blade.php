...
<head>
    ...
    <title>@yield('title','The Shoebox')</title>
    ...
    <link rel="stylesheet" href="{{ asset('edit-account.css') }}">
            ...
            @else
                <p class="poppins flex-row">
                    <span>
                        ...
                        <a href="{{ route('login') }}" class="flex-row">
                            Login
                        </a>
                    </span>
                    or
                    <span>
                        <a href="{{ route('register') }}" class="flex-row">
                            Register
                        </a>
                    </span>
                </p>
