    ...
    <div class="flex-row container">
        <div class="flex-column poppins categories">
            ...
            <div class="flex-column poppins list-categories">
                <a href="{{ route('sneakers')}}" class="flex-row">
                    <img src="img/icon/arrow-left.svg">
                    <span>Sneakers</span>
                </a>
               
                <a href="{{ route('boots')}}" class="flex-row">
                    <img src="img/icon/arrow-left.svg">
                    <span>Boots</span>
                </a>
                <a href="{{ route('sandals')}}" class="flex-row">
                    <img src="img/icon/arrow-left.svg">
                    <span>Sandals</span>
                </a>
        ...
        <a href='{{ route('product.index', $produk->id) }}'" class="flex-column product">
