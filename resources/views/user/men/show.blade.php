    ...
    <form class="flex-column container">
        ...
        <div class="flex-row product-detail">
            <div class="flex-row product-photo">
                <img src="{{ \Storage::url($produk->foto) }}" alt="product-1">
            </div>
            <div class="flex-column poppins product-description">
                ...
                <div class="flex-row poppins product-size">
                    ...
                    <select name="size" id="size">
                        ...
                        <?php
                        $str_arr = explode (",", $produk->size_produk); 
                ...
                <div class="flex-row poppins product-action">
                   ...
                   <button onClick="Cart()" type="submit" name="buy">Add to Cart</button>
                    <script>function Cart(){alert ("Added to Cart!");}</script>
                </div>
            </div>
        </div>
    </form>
